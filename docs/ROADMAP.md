...
| 014 | Three-layer 化 (capture / obs / mem)          | Proposed | 🚧 Phase 1-5 改訂実装済み、本番反映後の Phase 6 評価待ち |

## 直近の実装優先順位

| 順  | ADR | 工数      | 内容                                                                         | 依存                      |
| --- | --- | --------- | ---------------------------------------------------------------------------- | ------------------------- |
| 1   | 014 | 観察 1-2 週 | Phase 6: 改訂経路の本番観察、昇格率・品質・call 数・continuity・retry/quarantine・DB volume 確認 | Phase 1-5 改訂実装済み |
